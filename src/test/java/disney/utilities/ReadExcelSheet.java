...
public class ReadExcelSheet {
	...
	public static Map<String, Map<String, String>> setMapData() throws IOException {
		...
		String path = System.getProperty("user.dir") + "/src/test/resource/Datasheets/HuluDataSheet.xlsx";
		...
		for (int i = 0; i <= lastRow; i++) { // Looping over entire row
			...
			excelFileMap.put("HuluDataSheet", dataMap); // Putting dataMap to
														// excelFileMap
	...
	public static String getMapData(String key) throws Exception {
		Map<String, String> m = setMapData().get("HuluDataSheet");
